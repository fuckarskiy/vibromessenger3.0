...
window.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadProfile() {
    try {
      ...
      if (d.error) return alert("Не удалось загрузить профиль");
  ...
  // Загрузка пользователей для селекта
  ...
  // Автообновление истории DM при смене пользователя
